package br.com.keranbarbieri.todolist.task;
...
import br.com.keranbarbieri.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity create(@RequestBody TaskModel taskModel, HttpServletRequest request ){
        ...
        if(currentDate.isAfter(taskModel.getStartAt())
            ...
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("As datas de início e témino devem ser maior que a data atual!");
        }
